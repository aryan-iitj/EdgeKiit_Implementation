...
var reducers = tslib_1.__importStar(require("./reducers"));
var matchers = tslib_1.__importStar(require("./matchers"));
 ...
 */
exports.evaluateCondition = function (condition, pageViews) {
    ...
    var filteredPageViews = pageViews.filter(function (pageView) {
        return filter.queries.some(function (query) {
            ...
            return filters_1.queryMatches(query, pageFeatures);
        });
    });
