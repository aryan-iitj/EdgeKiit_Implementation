...
exports.sigmoid = exports.cosineSimilarity = exports.dotProduct = void 0;
...
exports.dotProduct = function (vectorA, vectorB) {
    return vectorA.reduce(function (acc, cur, idx) { return acc + cur * vectorB[idx]; }, 0);
};
exports.cosineSimilarity = function (vectorA, vectorB) {
    var cosineSim = exports.dotProduct(vectorA, vectorB) /
        (euclideanLength(vectorA) * euclideanLength(vectorB));
    return cosineScaler(cosineSim);
};
exports.sigmoid = function (z) {
